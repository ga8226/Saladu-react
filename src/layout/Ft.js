                    ...
                    <div className="pt-lg-4 pt-2">
                        <div>
                            <div className="d-flex justify-content-between">
                                ...
                                <ul className="d-flex">
                                    <li className="px-2"><a href="#none"><img src="../img/sns_insta.png" alt="인스타그램"/></a></li>
                                    <li className="px-2"><a href="#none"><img src="../img/sns_you.png" alt="유튜브"/></a></li>
                                    <li className="px-2"><a href="#none"><img src="../img/sns_fb.png" alt="페이스북"/></a></li>
                                </ul>
                            </div>
